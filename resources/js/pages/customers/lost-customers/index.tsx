...
import { ChevronLeft, ChevronRight, Trophy, UserCheck, Users } from 'lucide-react';
...
export default function AdminLostCustomers({ customers, employees, days }: Props) {
                            ...
                            <Card key={emp.id} className="flex items-center gap-4 p-4">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        KPI score:{' '}
                                        <span className="font-semibold text-foreground">{emp.kpi_score}</span>
                                    </p>
                                </div>
                            </Card>
                        ))}
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="min-w-52">Assigned to</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {customers.data.length === 0 ? (
                                <TableRow>
                                    ...
                                    >
                                        ...
                                        No lost customers right now — great retention!
                                    </TableCell>
                                </TableRow>
                            ) : (
                                    ...
                                    <TableRow key={customer.id}>
                                        ...
                                        <TableCell>
                                            <Select
                                                value={
                                                    customer.assigned_employee
                                                        ? String(customer.assigned_employee.id)
                                                        : 'none'
                                                }
                                                onValueChange={(val) => handleAssign(customer.id, val)}
                                            >
                                                <SelectTrigger
                        ...
                        <Pagination className="mx-0 sm:justify-end">
                            <PaginationContent>
                                <PaginationItem>
                                    ...
                                    >
                                        <a
                                            href={pageHref(Math.max(1, customers.current_page - 1))}
                                            className={
                                ...
                                {pageItems(customers.current_page, customers.last_page).map(
                                    (item, idx) =>
                                        item === 'ellipsis' ? (
                                            ...
                                            <PaginationItem key={item}>
                                                <PaginationLink
                                                    asChild
                                                    isActive={item === customers.current_page}
                                                >
                                ...
                                <PaginationItem>
                                    ...
                                    >
                                        <a
                                            href={pageHref(
                                                Math.min(customers.last_page, customers.current_page + 1),
                                            )}
                                            className={
